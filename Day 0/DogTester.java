public class DogTester {
    ...
    public static void main(String[] args) {
        Dog dog1 = new Dog();
        Dog dog2 = new Dog("John", "Jonah", 1, 425);
        Dog dog3 = new Dog("Chris", "Maria", 5, 456);
        ...
        System.out.println("Dog 2 Name, Age, Owner Name, ID, Character, Tag, Still in Facillity?: " + dog2.getName() +  " " 
