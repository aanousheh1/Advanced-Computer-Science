...
public class ArrayVersusArrayList {
    ...
    public static void lastComesFirst(ArrayList<String> arrList) {
        ...
        ArrayList<String> arr2 = new ArrayList<String>(arrList.size());
        ...
        String str = arrList.get(arrList.size() - 1);
        arr2.add(0, str);
    ...
    public static void firstComesLast(ArrayList<String> arrList) {
        ...
        for (int i = 0; i < arrList.size() - 1; i++) {
            arr2.add(i, arrList.get(i + 1));
        }

        arr2.add(arrList.size() - 1, str);
        for (int i = 0; i < arrList.size(); i++) {
            arrList.set(i, arr2.get(i));
        }
